...
function limit_element(param: [number]){
    return param;
}

function number_array(param: number[]){
    return param;
}

function string_array(param: string[]){
    return param;
}

function any_array(param: any[]){
    return param;
}

let arr=[1,2,3,4,5],arr2=[1,2,"hi",4]
...
console.log(any_array(arr)); // [ 1, 2, 3, 4, 5 ]
console.log(any_array(arr2)); //[ 1, 2, 'hi', 4 ]
